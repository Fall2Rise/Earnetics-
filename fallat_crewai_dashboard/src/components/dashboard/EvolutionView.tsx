            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-slate-900/40 border border-purple-500/20 rounded-2xl p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        {metrics?.successes.slice(0, 3).map((s, i) => (
                            <div key={i} className="p-3 bg-purple-500/5 border border-purple-500/10 rounded-xl">
                                <div className="text-[10px] text-purple-400 font-bold uppercase mb-1">Directive {i + 1}</div>
                                <p className="text-xs text-gray-300 leading-relaxed">
                                    Optimizing {s[1]} workflow for higher ROI based on recent success.
                                </p>
                            </div>
                        ))}
